...
# DVE full session
# Saved on Mon Oct 19 06:29:25 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{359 121} {1488 886}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 331} {child_wave_right 793} {child_wave_colname 217} {child_wave_colvalue 110} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 539505
